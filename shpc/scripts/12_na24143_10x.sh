#!/bin/bash
#SBATCH --job-name=physlr-na24143-10x
#SBATCH --output=./logs/na24143_10x.%j.out
#SBATCH --error=./logs/na24143_10x.%j.err
#SBATCH --mem=450G
#SBATCH --ntasks=1
...
# NA24143 10x Chromium: Build physical map and scaffold draft assemblies.
#
# Input: 10x Chromium linked reads (BX:Z: barcode tag, preprocessed by longranger basic)
# Drafts: ONT Shasta, PacBio Falcon, PE+MPET ABySS, Chromium Supernova, stLFR Supernova
#
# Prerequisites: Run 02_preprocess_10x.sh first to generate barcoded FASTQ.
#
# Usage: sbatch scripts/12_na24143_10x.sh
...
INPUT_FQ="${DATADIR}/na24143_10x/na24143.10x.barcoded.fq.gz"

# 10x Chromium parameters (from original Physlr paper)
K=40
W=32
OVERLAP_PCT=92.5
MOL_STRATEGY="bc+cc"
...
echo "============================================================"
echo "Physlr: NA24143 10x Chromium"
echo "Start: $(date)"
...
# Check input exists
if [ ! -f "${INPUT_FQ}" ]; then
    echo "ERROR: Barcoded FASTQ not found: ${INPUT_FQ}"
    echo "Run scripts/02_preprocess_10x.sh first."
    exit 1
fi
...
DRAFTS=(
    ...
    "na24143.stlfr.baseline.fa:supernova_stlfr"
    "na24143.10x.baseline.fa:supernova_10x"
)
...
echo ""
echo "============================================================"
echo "NA24143 10x Chromium: Complete"
echo "End: $(date)"
echo "Output: ${OUTDIR}"
echo "============================================================"
