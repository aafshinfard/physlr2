#!/bin/bash
#SBATCH --job-name=orig-physlr-na12878
#SBATCH --output=./logs/orig_physlr_na12878.%j.out
#SBATCH --error=./logs/orig_physlr_na12878.%j.err
#SBATCH --mem=300G
#SBATCH --ntasks=1
...
OUTDIR="${BASEDIR}/output/na12878_stlfr_original"
RUST_OUTDIR="${BASEDIR}/output/na12878_stlfr"
...
echo "============================================================"
echo "Original Physlr — NA12878 stLFR"
...
# The reads.tsv is the same regardless of pipeline — same indexlr, same k, same w.
