#!/bin/bash
#SBATCH --job-name=next-dsqcos-na12878
#SBATCH --output=./logs/next_dsqcosbin_na12878.%j.out
#SBATCH --error=./logs/next_dsqcosbin_na12878.%j.err
#SBATCH --mem=300G
#SBATCH --ntasks=1
...
# Re-run physlr-next from the molecule separation step onwards
# using distributed+sqcosbin instead of bc+cc.
# Reuses the filtered overlap graph from the previous run.
...
OUTDIR="${BASEDIR}/output/na12878_stlfr_dsqcosbin"
...
echo "============================================================"
echo "Physlr-next (distributed+sqcosbin) — NA12878 stLFR"
...
# Symlink the overlap.filtered.tsv from previous run
